...
import com.alibaba.link.ModuleManager;
...
public class ModuleManagerTest {
    ...
    @Test
    public void shouldLoadModule() throws MalformedURLException {
        //1:加载模块
    ...
    @Test
    public void shouldDoAction() throws MalformedURLException {
    ...
    public static ModuleConfig buildModuleConfig(boolean enabled)  {
        File file = new File("/Users/jifang.zjf/m2/com/alipay/jarslink/jarslink-module-demo/1.0.0/jarslink-module-demo-1.0.0.jar");
        ;
        URL demoModule  = null;// = Thread.currentThread().getContextClassLoader().getResource("jarslink-module-demo-1.0.0.jar");
        try {
            demoModule = file.toURL();
        ...
        moduleConfig.setPackageName("com.alipay.jarslink.demo");
    ...
    private Module loadModule() throws MalformedURLException {return moduleLoader.load(buildModuleConfig());}
